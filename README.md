...
This script has been last tested to work well with PyRosetta 4 Release 173 using Python 3.6 (further updates of PyRosetta breaks the MotifGraftMover and renders the script unusable - I am unable to accomodate whatever was updated). If you use this script on a newer PyRosetta or Python version and it fails please notify me of the error and I will update it.
